@echo off
REM Train on Part 2 of 5 (cleaned MPC data)
...
echo ============================================================
echo Training on Part 2/5 (Cleaned MPC Data - ~21,721 samples)
...
set TRAIN_FILE=%SPLITS_DIR%\train_part_2_cleaned.json
...
if not exist "%TRAIN_FILE%" (
    ...
    set TRAIN_FILE=%SPLITS_DIR%\train_part_2.json
)
