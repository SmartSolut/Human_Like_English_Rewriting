@echo off
REM Train on Part 4 of 5 (cleaned MPC data)
...
echo ============================================================
echo Training on Part 4/5 (Cleaned MPC Data - ~21,721 samples)
...
set TRAIN_FILE=%SPLITS_DIR%\train_part_4_cleaned.json
...
if not exist "%TRAIN_FILE%" (
    ...
    set TRAIN_FILE=%SPLITS_DIR%\train_part_4.json
)
...
echo.
echo ============================================================
echo Part 4/5 training completed!
echo ============================================================
pause
